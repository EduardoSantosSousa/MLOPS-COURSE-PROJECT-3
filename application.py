...
FEATURES_NAMES = ['Age', 'Fare', 'Pclass', 'Sex', 'Embarked', 'Familysize', 'Isalone','HasCabin', 'Title', 'Pclass_Fare', 'Age_Fare']
...
def fit_scaler_on_ref_data():
    ...
    all_features =feature_store.get_store_batch_features(entity_ids=entity_ids)
