...
def load_to_sql(file_path):
    ...
    engine = sqlalchemy.create_engine(f"postgresql+psycopg2://{conn.login}:{conn.password}@mlops-project-three_f0b12f-postgres-1:{conn.port}/{conn.schema}")
